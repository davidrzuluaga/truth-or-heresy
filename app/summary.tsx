...
export default function SummaryScreen() {
  ...
  const { data: gData, recordPerfectSession } = useGamification();
  ...
  useEffect(() => {
    if (isPerfect && !didAward.current) {
      didAward.current = true;
      setShowConfetti(true);
      playLevelUp();
      recordPerfectSession(bestStreak);
    }
  }, []);
      ...
      >
        ...
        <View style={{ flexDirection: "row", gap: 20, justifyContent: "center" }}>
          ...
          >
            ...
            <Text className="text-zinc-500 text-base">Home</Text>
          </Pressable>
          ...
          >
            ...
            <Text className="text-zinc-500 text-base">Progress</Text>
          </Pressable>
        </View>
      </ScrollView>
    </SafeAreaView>
